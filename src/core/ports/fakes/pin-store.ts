...
export type PinStoreCall =
  ...
  | { readonly method: "appendStandaloneEvent"; readonly pageSlug: PageSlug; readonly event: PinEvent }
...
export function createFakePinStore(): FakePinStore {
  ...
  async function appendStandaloneEvent(pageSlug: PageSlug, event: PinEvent): Promise<FailureDtoV1 | undefined> {
