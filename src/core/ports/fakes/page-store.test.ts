...
import type { PageRemovePlanV1 } from "core/protocol"
...
const FAILURE: FailureDtoV1 = { code: "PERSISTENCE_FAILED", retryable: false, safeMessage: "page unreadable", details: {} }
...
describe("createFakePageStore", () => {
  ...
  test("records calls in order with their arguments", async () => {
    ...
    expect(store.calls[1]).toMatchObject({ method: "renameTitle", pageSlug: slug("home"), title: "Home page" })
  })
})
