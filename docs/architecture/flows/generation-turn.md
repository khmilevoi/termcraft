...
12. Apply: under the project-write mutex, `TurnTransaction` first prepares
    ...
    at all. An empty diff records `"changedPages":[]`. Pins the message carried are
