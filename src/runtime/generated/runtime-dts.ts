...
export const RUNTIME_DTS = `declare module "@termcraft/runtime" {
   ...
   */
  declare function defineTweaks<T extends Record<string, unknown>>(declaration: T): T;
  /**
   ...
   */
  declare const hostModeAtom: import("@reatom/core").Atom<"export" | "preview", [newState: "export" | "preview"]>;
  declare const interactionModeAtom: import("@reatom/core").Atom<"interactive" | "static", [newState: "interactive" | "static"]>;
  /** True while the host renders this page for deterministic export (§6, §11.4). */
  declare const isExportAtom: import("@reatom/core").Computed<boolean>;
  /** A page-readable helper for the export flag (reads {@link isExportAtom}). */
  declare function isExport(): boolean;
   ...
   */
  declare function themeCapability(): ThemeCapability;
   ...
   */
  declare function usePages(): PagesCapability;
  /**
   ...
   */
  declare const viewportSizeAtom: import("@reatom/core").Atom<Size, [newState: Size]>;
  /**
   ...
   */
  declare const colorDepthAtom: import("@reatom/core").Atom<number, [newState: number]>;

  // ── src/runtime/model/define-page
  /** The runtime API version this binary authors new pages against (§7.1). */
  declare const CURRENT_KIT_API_VERSION = 1;
  /**
   ...
   */
  declare function definePage(meta: PageMeta): PageMeta;
   ...
   */
  declare function withConnectHook<Target extends AtomLike>(cb: (target: Target) => ConnectionHookResult): Ext<Target>;

  // ── src/runtime/model/tokens
  /** Resolve a theme id to its token palette (§5.4). Closed to the declared \`ThemeId\`. */
  declare function themeTokens(id: ThemeId): ThemeTokens;
   ...
   */
  declare function activeTokens(): ThemeTokens;
   ...
   */
  declare function Button(props: ButtonProps): React.ReactNode;
   ...
   */
  declare function Column(props: ColumnProps): React.ReactNode;
   ...
   */
  declare function Gauge(props: GaugeProps): React.ReactNode;
   ...
   */
  declare function Input(props: InputProps): React.ReactNode;
   ...
   */
  declare function List(props: ListProps): React.ReactNode;
   ...
   */
  declare function Panel(props: PanelProps): React.ReactNode;
  ...
  declare function Box(props: BoxProps): React.ReactNode;
   ...
   * host can answer geometry queries and the shell can select/pin it.
   */
  declare function Row(props: RowProps): React.ReactNode;
   ...
   */
  declare function Separator(props: SeparatorProps): React.ReactNode;
   ...
   */
  declare function Spacer(props: SpacerProps): React.ReactNode;
   ...
   */
  declare function Sparkline(props: SparklineProps): React.ReactNode;
   ...
   */
  declare function Table(props: TableProps): React.ReactNode;
   ...
   */
  declare function Tabs(props: TabsProps): React.ReactNode;
   ...
   */
  declare function Text(props: TextProps): React.ReactNode;
