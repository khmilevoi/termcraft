...
flowchart TD
    ...
    migoffer -- "⏎ migrate" --> migrun["verified backup + MigrationTransaction"] --> reopen2["reopen on format 2, second createShell"] --> wsmount
