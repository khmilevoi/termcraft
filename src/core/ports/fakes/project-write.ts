...
export type ProjectWriteCoordinatorCall =
  ...
  | { readonly seq: number; readonly method: "release"; readonly permitId: string; readonly effective: boolean }
  | { readonly seq: number; readonly method: "isActive"; readonly permitId: string; readonly result: boolean }
