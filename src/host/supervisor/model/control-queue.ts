...
import type { ControlQueue, CoalesceOutcome, QueuedCommand } from "../types"
...
function backpressuredError() {
  return new SupervisorError({ code: "HOST_BACKPRESSURED", reason: "outbound control queue full (256)" })
}
