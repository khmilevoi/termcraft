...
describe("buildChatChangedPayload", () => {
  test("defaults added/updated/removedChatIds to empty arrays", () => {
    const payload = buildChatChangedPayload({ activeChatId: "0192f6f0-0000-7000-8000-000000000001" })
  ...
  test("carries the given added/updated/removedChatIds verbatim", () => {
    const added = [{ chatId: "0192f6f0-0000-7000-8000-000000000002", createdAt: "2024-01-01T00:00:00.000Z" }]
